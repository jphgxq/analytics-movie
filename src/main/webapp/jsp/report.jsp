     ...
     <div class="container" style="margin-top:50px">
     	<div class="row-fluid">
     		...
     		<div class="col-md-8">
     			...
     			<textarea type="text" class="col-md-10"></textarea>
     			<label class="col-md-2">可选项</label>
     			<div class="col-md-10">
     			...
     			<div>
     				...
     				<input class="btn btn-default col-md-1" type="submit" value="确定">
     				<div class="col-md-1"></div>
     				<div class="col-md-1"></div>
     				<input class="btn btn-default col-md-1" type="submit" value="取消">
     				<div class="col-md-4"></div>
     			</div>
     		</div>
     		<div class="col-md-2"></div>
